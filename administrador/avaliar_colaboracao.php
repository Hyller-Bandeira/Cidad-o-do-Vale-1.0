...
?>
	...
	<script type="text/javascript" src="http://maps.google.com/maps/api/js?libraries=places,visualization"></script>
	...
	<script SRC="../src/util.js"></script>
		...
		//Consultas SQL
		$consulta = $connection->query("SELECT * FROM colaboracao WHERE codColaboracao = '$id'");
		...
		$consulta4 = $connection->query("SELECT * FROM classesdeusuarios WHERE codClasse = '$codigoClasse'");
		if(!($linhaDaConsulta4 = $consulta4->fetch_assoc())){
			echo "Erro na consulta : Não foi encontrado dados na tabela classesdeusuarios";
			exit;
		}
		
		$consulta5 = $connection->query("SELECT * FROM multimidia WHERE codColaboracao = '$id'");
		$numImagem = $consulta5->num_rows;
		
		$consulta8 = $connection->query("SELECT * FROM videos WHERE codColaboracao = '$id'");
		$numVideo = $consulta8->num_rows;
		
		$consulta11 = $connection->query("SELECT * FROM arquivos WHERE codColaboracao = '$id'");
		$numArquivo = $consulta11->num_rows;
		
		$consulta14 = $connection->query("SELECT * FROM estatistica WHERE codColaboracao = '$id'");
		if(!($linhaDaConsulta14 = $consulta14->fetch_assoc())){
										...
										<fieldset class="adminform">
											...
											<ul class="adminformlist">
												...
												<li>
													...
													$consulta1 = $connection->query("SELECT * FROM categoriaevento WHERE codCategoriaEvento = '$codCat'");
												...
												<li>
													...
													$consulta2 = $connection->query("SELECT * FROM tipoevento WHERE codTipoEvento = '$codTip'");
										...
										<fieldset class="adminform">
											...
											<ul class="adminformlist">
												<?php  if($numImagem==0)
														...
														$linhaDaConsulta5 = $consulta5->fetch_assoc();
														?>
														<li>
										...
										<fieldset class="adminform long">
											...
											<ul class="adminformlist">
												<?php  if($numImagem==0)
														...
														$consulta6 = $connection->query("SELECT * FROM usuario WHERE codUsuario = '$codUser'");
															if(!($linhaDaConsulta6 = $consulta6->fetch_assoc())){
																echo "Erro na consulta : Não foi encontrado dados na tabela usuario";
																exit;
															}
														?>
												...
												<li>
													<?php 
														...
														$consulta7 = $connection->query("SELECT * FROM classesdeusuarios WHERE codClasse = '$codigoClasse2'");
														if(!($linhaDaConsulta7 = $consulta7->fetch_assoc())){
															echo "Erro na consulta : Não foi encontrado dados na tabela classesdeusuarios";
															exit;
														}
													?>
										...
										<fieldset class="adminform">
											...
											<ul class="adminformlist">
												<?php  if($numVideo==0)
														...
														$linhaDaConsulta8 = $consulta8->fetch_assoc();
														?>
														<li>
										...
										<fieldset class="adminform long">
											...
											<ul class="adminformlist">
												<?php  if($numVideo==0)
														...
														$consulta9 = $connection->query("SELECT * FROM usuario WHERE codUsuario = '$codUser2'");
															if(!($linhaDaConsulta9 = $consulta9->fetch_assoc())){
																echo "Erro na consulta : Não foi encontrado dados na tabela usuario";
																exit;
															}
														?>
												...
												<li>
													<?php 
														...
														$consulta10 = $connection->query("SELECT * FROM classesdeusuarios WHERE codClasse = '$codigoClasse3'");
														if(!($linhaDaConsulta10 = $consulta10->fetch_assoc())){
															echo "Erro na consulta : Não foi encontrado dados na tabela classesdeusuarios";
															exit;
														}
													?>
										...
										<fieldset class="adminform">
											...
											<ul class="adminformlist">
												<?php  if($numArquivo==0)
														...
														$linhaDaConsulta11 = $consulta11->fetch_assoc();
														?>
														<li>
										...
										<fieldset class="adminform long">
											...
											<ul class="adminformlist">
												<?php  if($numArquivo==0)
														...
														$consulta12 = $connection->query("SELECT * FROM usuario WHERE codUsuario = '$codUser3'");
															if(!($linhaDaConsulta12 = $consulta12->fetch_assoc())){
																echo "Erro na consulta : Não foi encontrado dados na tabela usuario";
																exit;
															}
														?>
												...
												<li>
													<?php 
														...
														$consulta13 = $connection->query("SELECT * FROM classesdeusuarios WHERE codClasse = '$codigoClasse4'");
														if(!($linhaDaConsulta13 = $consulta13->fetch_assoc())){
															echo "Erro na consulta : Não foi encontrado dados na tabela classesdeusuarios";
															exit;
														}
													?>
