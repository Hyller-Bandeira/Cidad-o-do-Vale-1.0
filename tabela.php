<?php
	...
	$x->addCustomControl(EyeDataGrid::CUSCTRL_TEXT, "mostrarColaboracao(%codColaboracao%, %numLatitude%, %numLongitude%); ga('send', 'event', 'Clique', 'Link', 'Visualizar (Tabela de Dados Histórico)');", EyeDataGrid::TYPE_ONCLICK, 'Visualizar');
