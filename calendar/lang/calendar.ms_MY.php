...
setlocale(LC_ALL,  "Malay_malaysia", "Malay_malaysia.1252", "zlm_zlm", "zlm.ISO-8859-1", "MSA_MAY.ISO-8859-1", "MSA_MAY", "malaysian"); // For Windows servers
} else {
setlocale(LC_ALL, "ms_MY.UTF8", "ms_MY", "msa.ISO-8859-1", "msa_may.ISO-8859-1"); // For Unix/FreeBSD servers
}
?>