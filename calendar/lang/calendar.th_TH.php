...
define("L_UNSET", "??????");
define("L_CLOSE", "???");
define("L_WARN_2038", "??????? php server ?????????????????????????????? 2038 ????????! (<5.3.0)");
define("L_ERR_NOSET", "??????????! ?????????????????????????!");
...
setlocale(LC_ALL, "tha-tha.ISO-8859-1", "tha-tha", "Thai.ISO-8859-1", "Thai");
} else {
setlocale(LC_ALL, "th_TH.ISO-8859-1", "tha.ISO-8859-1", "tha_tha.ISO-8859-1", "Thai.ISO-8859-1");
}
