...
setlocale(LC_ALL, "dutch.ISO-8859-1", "nld_nld.ISO-8859-1", "nld.ISO-8859-1", "dutch");
} else {
setlocale(LC_ALL, "nl_NL.ISO-8859-1", "nl_NL.ISO-8859-1@euro", "nld_nld.ISO-8859-1", "nld.ISO-8859-1");
}
?>