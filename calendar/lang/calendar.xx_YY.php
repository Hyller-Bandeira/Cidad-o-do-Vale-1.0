...
# Version: 3.70
# Language: Lang_name / Orig_name // Ex: Romanian (English name) / Româna (Original name)
...
# Dates - genitive #3.69
// Note: only for languages that require this transformation like Slavonian languages, Greek, Russian, Ukrainean aso. E.g. 1st of October in Greek is 1? ??t?ß????, but the month name is ??t?ß???? (in drop downs of the calendar)
/*
...
setlocale(LC_ALL, "eng-usa.ISO-8859-1", "eng-usa", "English-usa.ISO-8859-1");
} else {
...
#define("L_ARABIC_DIGIT", "?, ?, ?, ?, ?, ?, ?, ?, ?, ?"); //list the local digits 0 to 9 in your language
...
#define("L_INDIC", "??????"); // To switch to local format digits
?>