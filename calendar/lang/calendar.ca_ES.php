...
# Version: 3.70
# Language: Catalan / català (in your lang) // ex: Romanian / Româna
...
setlocale(LC_ALL, "cat-esp.ISO-8859-1", "cat-esp", "Catalan_Spain", "Catalan-esp.ISO-8859-1");
} else {
setlocale(LC_ALL, "ca_ES.ISO-8859-1", "ca_ES.ISO-8859-1@euro", "ca_ES@euro", "esp.ISO-8859-1", "cat_esp.ISO-8859-1", "Catalan-esp.ISO-8859-1","catalan.ISO-8859-1");
}
?>