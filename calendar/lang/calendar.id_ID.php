...
setlocale(LC_ALL, "IND_IND.ISO-8859-1", "IND_IND", "indonesian.ISO-8859-1", "indonesian"); // For Windows servers
} else {
setlocale(LC_ALL, "id_ID.ISO-8859-1", "id_ID", "ind.ISO-8859-1", "ind_ind.ISO-8859-1"); // For Unix/FreeBSD servers
}
?>