...
define("L_CHK_VAL", "Seçilmis tarihi kontrol et");
define("L_SEL_LANG", "Dil Seçimi");
define("L_SEL_ICON", "Seç");
define("L_SEL_DATE", "Tarih Seçimi");
define("L_ERR_SEL", "Geçersiz bir seçim yeptiniz");
...
define("L_DATE_BETWEEN", "%s ve %s\\narasindaki bir tarih seçin");
define("L_WEEK_HDR", ""); // Optional Short Name for the column header showing the current Week number (W or CW in English - max 2 letters)
define("L_UNSET", "Iptal"); // Seçimi kaldir
define("L_CLOSE", "Kapat");
define("L_WARN_2038", "Bu php sunucusu sürümü 2038 yili ve sonrasini desteklemiyor! (<5.3.0)");
