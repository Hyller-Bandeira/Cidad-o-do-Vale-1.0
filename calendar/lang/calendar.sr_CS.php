...
# Translator: Vedran Vucic <vedran.vucic@gnulinuxcentar.org>
...
define("L_NEXT", "Sledeci");
define("L_REF_CAL", "Ponovo ucitavam Kalendar...");
...
define("L_POWBY", "Pokrece:"); //or "Based on:", "Supported by"
define("L_HERE", "ovde");
define("L_UPDATE", "Moguce ažuriranje %s !");
define("L_TRANAME", "Vedran Vucic");
...
setlocale(LC_ALL, "serbian (latin).ISO-8859-1", "serbian (latin)");
} else {
setlocale(LC_ALL, "sr_RS@latin", "sr_CS.ISO-8859-1", "srl.ISO-8859-1", "srp_srp.ISO-8859-1", "sr.ISO-8859-1", "serbian.ISO-8859-1"); // For SR formats
}
?>