...
?>
	...
	<html>
		<?php 		
		//Consultas SQL
		$consulta = mysql_query("SELECT * FROM classesdeusuarios ORDER BY codClasse ASC");
		$numClasses = mysql_num_rows($consulta);
				...
				<form action="#" id="application-form" method="post" name="listarclasseUsuarios" class="form-validate">
					<table class="adminlist">
						...
						<tbody>
							<?php 
							$i = 0;
							while($classeUsuario=mysql_fetch_array($consulta)){
